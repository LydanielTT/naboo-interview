...
export class UserResolver {
  ...
  async addFavoriteActivity(
    ...
    return this.userService.addFavoriteActivity(context.jwtPayload.id, activityId);
  }
  ...
  async removeFavoriteActivity(
    ...
    return this.userService.removeFavoriteActivity(context.jwtPayload.id, activityId);
  }
}
